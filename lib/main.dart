    ...
    return BlocBuilder<AppCubit, AppState>(
        ...
        builder: (context, _) {
          ...
          return DynamicColorBuilder(builder: (ColorScheme? lightDynamic, ColorScheme? darkDynamic) {
            ...
            log.fine('locale from db ${db.getSettings(localeSettingName)?.value} from cubit: $dbLocale, $localeString');
            ...
            return MaterialApp.router(
              ...
              themeMode: ThemeMode.values
                  .firstWhere((element) => element.name == themeMode.name, orElse: () => ThemeMode.system),
              title: 'Clipious',
              theme: ThemeData(
                  useMaterial3: true,
                  colorScheme: lightColorScheme,
