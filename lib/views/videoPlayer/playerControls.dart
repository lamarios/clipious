...
import '../../controllers/videoPlayerController.dart';
import '../../utils.dart';

class PlayerControls extends StatelessWidget {
  final PlayerCubit? mediaPlayerCubit;

  const PlayerControls({super.key, this.mediaPlayerCubit});

  showPlaybackSpeedSelection(BuildContext context, PlayerCubit player) {
  ...
  showOptionMenu(BuildContext context, PlayerControlController controls, PlayerCubit pc) {
      ...
      child: BlocProvider(
        ...
        child: BlocBuilder<PlayerControlCubit, PlayerControlController>(
          builder: (context, _) {
            ...
            MiniPlayerController mpc = player.state;
            var event = _.event;
            var cubit = context.read<PlayerControlCubit>();
            return BlocListener<MiniPlayerCubit, MiniPlayerController>(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  icon: Icon(player.state.isPlaying ? Icons.pause : Icons.play_arrow, size: 75),
                                ),
                                IconButton(
