...
class TvPlaylistGridScreen extends StatelessWidget {
  ...
  const TvPlaylistGridScreen({super.key, required this.playlistList, this.tags});
            ...
            return Column(
              children: [
                ...
                Expanded(
                  ...
                  children: [
                    ..._.playlists.map((e) =>
                        PlaylistInList(key: ValueKey(e.playlistId), playlist: e, canDeleteVideos: false, isTv: true)),
