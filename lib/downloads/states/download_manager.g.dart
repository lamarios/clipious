...
abstract class _$DownloadManagerStateCWProxy {
  DownloadManagerState animateToController(AnimateToController animateToController);

  DownloadManagerState videos(List<DownloadedVideo> videos);

  DownloadManagerState downloadProgresses(Map<String, DownloadProgress> downloadProgresses);
...
class _$DownloadManagerStateCWProxyImpl implements _$DownloadManagerStateCWProxy {
  const _$DownloadManagerStateCWProxyImpl(this._value);

  final DownloadManagerState _value;

  @override
  DownloadManagerState animateToController(AnimateToController animateToController) => this(animateToController: animateToController);

  @override
  DownloadManagerState videos(List<DownloadedVideo> videos) => this(videos: videos);

  @override
  DownloadManagerState downloadProgresses(Map<String, DownloadProgress> downloadProgresses) => this(downloadProgresses: downloadProgresses);
  ...
  DownloadManagerState call({
    ...
    return DownloadManagerState._(
      animateToController == const $CopyWithPlaceholder() || animateToController == null
      ...
      downloadProgresses == const $CopyWithPlaceholder() || downloadProgresses == null
...
extension $DownloadManagerStateCopyWith on DownloadManagerState {
  ...
  _$DownloadManagerStateCWProxy get copyWith => _$DownloadManagerStateCWProxyImpl(this);
}
