...
final _entities = <ModelEntity>[
  ...
  ModelEntity(id: const IdUid(7, 7737259498144569754), name: 'DownloadedVideo', lastPropertyId: const IdUid(7, 4130320220878296738), flags: 0, properties: <ModelProperty>[
    ModelProperty(id: const IdUid(1, 4941717954477256691), name: 'id', type: 6, flags: 1),
    ModelProperty(id: const IdUid(2, 6600296338817128660), name: 'videoId', type: 9, flags: 0),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      ...
      retiredPropertyUids: const [3422621380867834787, 971220157301355316, 7030952573865954657],
  ...
  final bindings = <Type, EntityDefinition>{
    Server: EntityDefinition<Server>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = Server(const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 6, ''))
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0)
            ..authToken = const fb.StringReader(asciiOptimization: true).vTableGetNullable(buffer, rootOffset, 8)
            ..inUse = const fb.BoolReader().vTableGet(buffer, rootOffset, 14, false)
            ..sidCookie = const fb.StringReader(asciiOptimization: true).vTableGetNullable(buffer, rootOffset, 16);
    ...
    SettingsValue: EntityDefinition<SettingsValue>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object =
              SettingsValue(const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 6, ''), const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 8, ''))
                ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
    ...
    Progress: EntityDefinition<Progress>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = Progress(const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0), const fb.Float64Reader().vTableGet(buffer, rootOffset, 6, 0),
    ...
    SearchHistoryItem: EntityDefinition<SearchHistoryItem>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = SearchHistoryItem(const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 6, ''), const fb.Int64Reader().vTableGet(buffer, rootOffset, 8, 0))
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
    ...
    AppLog: EntityDefinition<AppLog>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = AppLog(
              level: const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 6, ''),
              logger: const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 14, ''),
              time: DateTime.fromMillisecondsSinceEpoch(const fb.Int64Reader().vTableGet(buffer, rootOffset, 8, 0)),
              message: const fb.StringReader(asciiOptimization: true).vTableGetNullable(buffer, rootOffset, 10),
              stacktrace: const fb.StringReader(asciiOptimization: true).vTableGetNullable(buffer, rootOffset, 12))
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
    ...
    VideoFilter: EntityDefinition<VideoFilter>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = VideoFilter(
              value: const fb.StringReader(asciiOptimization: true).vTableGetNullable(buffer, rootOffset, 8),
              channelId: const fb.StringReader(asciiOptimization: true).vTableGetNullable(buffer, rootOffset, 6))
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0)
    ...
    DownloadedVideo: EntityDefinition<DownloadedVideo>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = DownloadedVideo(
              id: const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0),
              videoId: const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 6, ''),
              title: const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 8, ''),
              author: const fb.StringReader(asciiOptimization: true).vTableGetNullable(buffer, rootOffset, 10),
              authorUrl: const fb.StringReader(asciiOptimization: true).vTableGetNullable(buffer, rootOffset, 12),
              downloadComplete: const fb.BoolReader().vTableGet(buffer, rootOffset, 14, false),
              downloadFailed: const fb.BoolReader().vTableGet(buffer, rootOffset, 16, false));
...
class DownloadedVideo_ {
  ...
  static final videoId = QueryStringProperty<DownloadedVideo>(_entities[6].properties[1]);

  /// see [DownloadedVideo.title]
  static final title = QueryStringProperty<DownloadedVideo>(_entities[6].properties[2]);

  /// see [DownloadedVideo.author]
  static final author = QueryStringProperty<DownloadedVideo>(_entities[6].properties[3]);

  /// see [DownloadedVideo.authorUrl]
  static final authorUrl = QueryStringProperty<DownloadedVideo>(_entities[6].properties[4]);

  /// see [DownloadedVideo.downloadComplete]
  static final downloadComplete = QueryBooleanProperty<DownloadedVideo>(_entities[6].properties[5]);

  /// see [DownloadedVideo.downloadFailed]
  static final downloadFailed = QueryBooleanProperty<DownloadedVideo>(_entities[6].properties[6]);
}
