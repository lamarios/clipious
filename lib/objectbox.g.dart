...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      ...
      retiredPropertyUids: const [3422621380867834787, 971220157301355316, 7030952573865954657, 6600296338817128660, 345286493546760360],
    ...
    DownloadedVideo: EntityDefinition<DownloadedVideo>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = DownloadedVideo(
              id: const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0),
              videoId: const fb.StringReader(asciiOptimization: true).vTableGet(buffer, rootOffset, 26, ''),
              ...
              audioOnly: const fb.BoolReader().vTableGet(buffer, rootOffset, 18, false),
              lengthSeconds: const fb.Int64Reader().vTableGet(buffer, rootOffset, 24, 0),
