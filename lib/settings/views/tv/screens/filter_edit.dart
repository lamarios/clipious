        ...
        : [
            SettingsTile(
              ...
              onSelected: (context) => AutoRouter.of(context).push(TvSelectFromListRoute(
                  ...
                  onSelect: (type) {
                    cubit.setType(
                        FilterType.values.where((t) => FilterType.localizedType(t, locals) == type).firstOrNull);
                  },
                  title: locals.videoFilterType)),
            ),
            Visibility(
              ...
              child: SettingsTile(
                ...
                onSelected: (context) => AutoRouter.of(context).push(TvSelectFromListRoute(
                    options:
                        cubit.getAvailableOperations().map((e) => FilterOperation.localizedLabel(e, locals)).toList(),
                    selected: FilterOperation.localizedLabel(_.filter?.operation, locals),
                    onSelect: (operation) {
                      cubit.setOperation(FilterOperation.values
                          .where((t) => FilterOperation.localizedLabel(t, locals) == operation)
                          .firstOrNull);
                    },
                    title: locals.videoFilterType)),
              ),
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    TvTimePicker(
                                        value: _.filter?.startTime ?? '00:00', onTimePicked: cubit.setStartTime),
                                  ],
                                ),
                                Row(
                                  mainAxisSize: MainAxisSize.min,
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(100), color: colors.secondaryContainer),
                            child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text(_.filter?.localizedLabel(locals, context) ?? '',
