...
class TvSettingsManageServers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocProvider(create: (BuildContext context) => ServerListSettingsCubit(ServerListSettingsState(publicServers: [], dbServers: [])), child: const TvOverscan(child: TvManageServersInner())),
    );
  }
}
