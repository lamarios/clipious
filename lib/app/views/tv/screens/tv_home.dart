...
class TvHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Not using a builder / auto refreshing on purpose
    var server = context.read<AppCubit>().state.server;
    if (server == null) {
      showWizard = true;
    }
    return showWizard
                        ...
                        AnimatedContainer(
                          ...
                          child: Padding(
                              padding: EdgeInsets.only(
                                  ...
                                  right: homeState.expandMenu ? TvOverscan.horizontal : 8),
                              child: Column(
