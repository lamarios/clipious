...
mixin _$VideoPlayerState {
  ColorScheme get colors => throw _privateConstructorUsedError;
  Color get overFlowTextColor => throw _privateConstructorUsedError;
  GlobalKey<State<StatefulWidget>> get key =>
      throw _privateConstructorUsedError;
  Duration? get startAt => throw _privateConstructorUsedError;
  String get selectedNonDashTrack => throw _privateConstructorUsedError;
  Duration? get bufferPosition => throw _privateConstructorUsedError;
...
class _$VideoPlayerStateImpl extends _VideoPlayerState {
...
abstract class _VideoPlayerState extends VideoPlayerState {
  const factory _VideoPlayerState(
      {required final ColorScheme colors,
      required final Color overFlowTextColor,
      ...
      final DownloadedVideo? offlineVideo,
      final bool? playNow,
      final bool? disableControls}) = _$VideoPlayerStateImpl;
  const _VideoPlayerState._() : super._();
