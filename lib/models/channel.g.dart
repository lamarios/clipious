...
Channel _$ChannelFromJson(Map<String, dynamic> json) => Channel(
      ...
      (json['authorBanners'] as List<dynamic>?)?.map((e) => ImageObject.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      (json['latestVideos'] as List<dynamic>?)?.map((e) => VideoInList.fromJson(e as Map<String, dynamic>)).toList(),
    );
